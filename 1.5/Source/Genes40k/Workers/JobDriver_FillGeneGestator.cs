...
namespace Genes40k
{
    public class JobDriver_FillGeneGestator : JobDriver
    {
        ...
        protected Building_GeneGestator GeneGestator => (Building_GeneGestator)job.GetTarget(TargetIndex.A).Thing;

        protected Thing GeneMatrix => job.GetTarget(TargetIndex.B).Thing;
